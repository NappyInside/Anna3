...
<form action="?ctrl=marks&action=ajouter" method="post">
	...
	<div class="row">
		...
		<div class="row">
			...
			<div class="col-lg-4">
				<div class="form-group">
					<input required type="number" name="mark" id="mark" placeholder="Note obtenue sur 20" class="form-control" min="0" max="20.00" step="0.01">
				</div>
			</div></div>
			<hr class="hr-dashed">
			...
			<form role = "form">
				...
				<div class="row">
					...
					<div class="col-lg-4">
						<div class = "form-group">
							<textarea class = "form-control" name="comment" rows = "3" placeholder="Veuillez saisir un commentaire" onkeyup="javascript:MaxLengthTextarea(this, 150);"></textarea>
				...
				<!-- Limitation du textarea à 150 caractères dans le commentaire -->
